...
This finalwork is about a robot car controlled with smartphone by connecting to wifi.
...
**系統方塊**
![](https://github.com/DENG0616/MCU-project/blob/main/images/final.png?raw=true)
**實作相片**
![](https://github.com/DENG0616/MCU-project/blob/main/images/A3.jpg?raw=true)
**實作相片**
![](https://github.com/DENG0616/MCU-project/blob/main/images/A2.jpg?raw=true)
**實作相片**
![](https://github.com/DENG0616/MCU-project/blob/main/images/A1.jpg?raw=true)

**實作影片**
**座標偵測實作**
<iframe width="350" height="622" src="https://www.youtube.com/embed/4tvbFpI4C40" title="2023年6月4日" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
**小車實作影片-1**
<iframe width="350" height="622" src="https://www.youtube.com/embed/b1AzkakRuUk" title="2023年6月4日" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
**小車實作影片-2**
<iframe width="350" height="622" src="https://www.youtube.com/embed/9uHduNI7L98" title="2023年6月4日" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>

**程式碼**
* 程式碼的部份我們每位同學都有做出無錯版本,雖然不是最後老師要求的版本,但都有完成部分的功能如腳位偵測或是部分修正。 
*
**程式碼-1**
```
#include <Wire.h>
